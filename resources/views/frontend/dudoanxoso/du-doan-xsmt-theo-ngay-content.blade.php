<div class="the-article-content">
    <h2 class="the-article-summary">Xem thống kê dự đoán
        @if (isset($pro_custom))
            {{ $pro_custom->name }}
        @endif
        XSMT hôm nay ngày {{ getngayThang1($date) }} - Soi cầu xổ số
        miền
        Trung chính xác 100 từ cao thủ soi cầu số 1 chốt số siêu chuẩn hoàn toàn miễn phí. Dự đoán kết quả XSMT
    ...
    @if (isset($pro_custom))
        <div class="pascal">
            ...
            <div class="pascal-body">
                <p>Giải đặc biệt: <span class="red conso_dudoan">{{ $pascal[$pro_custom->short_name]['gdb'] }}</span></p>
