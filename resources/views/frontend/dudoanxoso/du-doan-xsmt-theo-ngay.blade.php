...
@section('decription','Dự đoán XSMT '.getNgay($dudoan->date).' chính xác từ cao thủ soi cầu số 1 hiện nay. Soi cầu xổ số miền Trung chính xác 100, hoàn toàn miễn phí trên xosotructiep.online')
