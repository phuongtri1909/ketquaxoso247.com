...
<div data-id="kq" class="one-city" data-region="1" data-zoom="0" data-sub="0" data-sound="1">
    <div class="box" id="beginroll">
        ...
        <div class="see-more">
            <div class="bold see-more-title">⇒ Ngoài ra bạn có thể xem thêm: Xổ Số Miền Nam</div>
            <ul class="list-html-link two-column">
                <li>Mời bạn <a href="{{ route('quay_thu.mn') }}" title="quay thử miền Nam">quay thử miền Nam</a> hôm
                    nay để lấy hên
                </li>
