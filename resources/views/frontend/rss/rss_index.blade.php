...
@section('content')
    <div class="content-rss col-l">
        <div class="title-rss">ketquaxoso247.com - RSS</div>
        ...
        <div class="q-rss">ketquaxoso247.com cung cấp những kênh thông tin RSS sau:</div>
        <div class="list-tk">
            <div class="one-item">
        ...
        <div class="a-rss">Các nguồn kênh tin được cung cấp miễn phí cho các cá nhân và các tổ chức phi lợi nhuận. Chúng tôi yêu cầu bạn cung cấp rõ các thông tin cần thiết khi bạn sử dụng các nguồn kênh tin này từ ketquaxoso247.com</div>
        <div class="a-rss">ketquaxoso247.com hoàn toàn có quyền yêu cầu bạn ngừng cung cấp và phân tán thông tin dưới dạng này ở bất kỳ thời điểm nào và với bất kỳ lý do nào.</div>
    </div>
@endsection
