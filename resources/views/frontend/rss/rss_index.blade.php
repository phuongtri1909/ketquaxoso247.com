...
@section('content')
    <div class="content-rss col-l">
        <div class="title-rss">xosotructiep.online - RSS</div>
        ...
        <div class="q-rss">xosotructiep.online cung cấp những kênh thông tin RSS sau:</div>
        <div class="list-tk">
            <div class="one-item">
        ...
        <div class="a-rss">Các nguồn kênh tin được cung cấp miễn phí cho các cá nhân và các tổ chức phi lợi nhuận. Chúng tôi yêu cầu bạn cung cấp rõ các thông tin cần thiết khi bạn sử dụng các nguồn kênh tin này từ xosotructiep.online</div>
        <div class="a-rss">xosotructiep.online hoàn toàn có quyền yêu cầu bạn ngừng cung cấp và phân tán thông tin dưới dạng này ở bất kỳ thời điểm nào và với bất kỳ lý do nào.</div>
    </div>
@endsection
