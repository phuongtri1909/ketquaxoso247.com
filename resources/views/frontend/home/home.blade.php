        ...
        <div class="box-kq">
            ...
            <div class="box-content">
                <div class="content-news">
                     <h2 class="text-center"><strong > Giới thiệu về trang KQXS - ketquaxoso247.com - XO SO HOM NAY</strong></h2>
                     <p><a href="{{ route('home') }}"><strong>ketquaxoso247.com</strong> </a> là trang kết quả xổ số trực tuyến nhanh nhất và chính xác nhất tại Việt Nam. Với giao diện thân thiện và dễ sử dụng, xổ sổ trực tiếp giúp người dùng theo dõi <a href="{{ route('home') }}"><strong>kqxs</strong></a> mọi lúc, mọi nơi một cách tiện lợi và nhanh chóng.</p>
                     ...
                     <p>Không chỉ trực tiếp <a href="{{ route('home') }}"><strong>KQXS</strong></a> ba miền, <a href="{{ route('home') }}"><strong>ketquaxoso247.com</strong> </a> còn nhiều tiện ích khác dành cho bạn như dự đoán xổ số, thống kê lô tô, xổ số vietlott, xổ số điện toán hoàn toàn miễn phí.</p>
                </div>
            </div>
        </div>
    </div>
