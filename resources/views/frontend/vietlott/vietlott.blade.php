...
@section('content')
    <div class="col-l">
        ...
        <div class="box-content">
                ...
                <p><span style="font-weight: 400;"><strong><a href="{{route('vietlott')}}" title="XS Vietlott"><span style="color:#0000FF"> Kết Quả XS Vietlott</span> </a></strong>. KQXS Vietlott. Kết Quả Xổ Số Vietlott. ketquaxoso247.com nơi cập nhật Kết quả Xổ Số Vietlott nhanh v&agrave; ch&iacute;nh x&aacute;c nhất.</span></p>
            ...
            <p><span style="font-weight: 400;">Kết quả Xổ Số Vietlott được cập nhật li&ecirc;n tục, nhanh ch&oacute;ng v&agrave; ch&iacute;nh x&aacute;c tại ketquaxoso247.com</span></p>
        </div>
    </div>
@endsection
