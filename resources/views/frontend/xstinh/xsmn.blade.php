    ...
    <div class="col-l" style="height: auto !important;">
        ...
        <div class="box-content">
            ...
            <p><span style="font-size:14px">SX{{ strtoupper($province->short_name) }} - Trực tiếp kết quả <a style="text-decoration: underline" title="xổ số {{ $province->name }}"
                    ...
                    {{ $thu }} hàng tuần trên website xosotructiep.online cập nhật mới nhất. Ngoài ra còn có các tiện ích
            ...
            <p>
                <span style="font-size:14px">
                    Theo dõi xosotructiep.online để xem <a style="text-decoration: underline" title="KQXS" href="{{ route('home') }}">KQXS</a> nhanh nhất và chính xác nhất hàng ngày miễn phí.
                </span>
            </p>
        </div>
    </div>
