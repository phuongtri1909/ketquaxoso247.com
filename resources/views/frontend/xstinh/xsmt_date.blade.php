        ...
        @if(!empty($xsmt))
            ...
            <div class="box" id='kqngay_{{getNgayID($xsmt->date)}}'>
                ...
                <div>
                   ...
                   <p> <strong> XS{{strtoupper($province->short_name)}} {{$province->name}}  {{getNgay($date)}} - Kết quả xổ số {{$province->name}} hôm nay nhanh nhất tại ketquaxoso247.com Xổ số {{getNgay($date)}}</strong>
                    </p>
                    ...
                    <p>Kết quả xổ số XS{{strtoupper($province->short_name)}} {{$province->name}}  {{getNgay($date)}} được công bố trên các trang web ketquaxoso247.com đề hoặc trên các kênh truyền hình vào mỗi ngày {{getNgay($date)}}. </p>
        ...
        @else
            <div class="box" id='kqngay_{{getNgayID($date)}}'>
                ...
                <div class="box-content">
                   ...
                   <p> <strong> XS{{strtoupper($province->short_name)}} {{$province->name}}  {{getNgay($date)}} - Kết quả xổ số {{$province->name}} hôm nay {{getNgay($date)}} nhanh nhất tại ketquaxoso247.com Xổ số {{getNgay($date)}}</strong>
                    </p>
                    ...
                    <p>Kết quả xổ số XS{{strtoupper($province->short_name)}} {{$province->name}}  {{getNgay($date)}} được công bố trên các trang web ketquaxoso247.com đề hoặc trên các kênh truyền hình vào mỗi ngày. </p>
