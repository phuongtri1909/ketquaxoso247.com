                ...
                <div class="see-more">
                    ...
                    <ul class="list-html-link two-column">
                        <li>Mời bạn <a href="{{route('quay_thu.mn')}}"
                                       title="quay thử miền Nam">quay thử miền Nam</a> hôm nay để lấy hên trên ketquaxoso247.com
                        </li>
                       ...
                       <li> Xem lại kết quả xổ số ngày hôm trước  <a href="{{route('xsmn.date',getNgayLink($xsmn_pre->date))}}"  title="KQXSMB ngày {{getNgay($xsmn_pre->date)}}"> kết quả xổ số ngày hôm trước</a> với ngày gần nhất </li>
                        <li> Xổ số Miền Nam {{getThu($xsmnTinh->day)}} </li>
                           ...
                           <p> <strong>Xổ số miền Nam {{getNgay($date)}} </li> - Kết quả xổ số miền Nam XSMN hôm nay nhanh nhất tại ketquaxoso247.com Xổ số miền Nam {{getNgay($date)}}</strong>
                            </p>
                            ...
                            <p>Kết quả xổ số miền Nam {{getNgay($date)}} được công bố trên các trang web ketquaxoso247.com đề hoặc trên các kênh truyền hình vào mỗi ngày. </p>
