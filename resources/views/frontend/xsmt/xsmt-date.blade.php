                ...
                <div class="see-more">
                    ...
                    <ul class="list-html-link two-column">
                     ...
                     <div class="box-content">
                       <p> <strong> Xổ số miền Trung {{getNgay($date)}} </li> - Kết quả xổ số miền Trung hôm nay nhanh nhất tại ketquaxoso247.com Xổ số miền Trung {{getNgay($date)}}</strong>
                        </p>
                        ...
                        <p>Kết quả xổ số miền Trung  XSMT{{getNgay($date)}} được công bố trên các trang web ketquaxoso247.com đề hoặc trên các kênh truyền hình vào mỗi ngày. </p>
