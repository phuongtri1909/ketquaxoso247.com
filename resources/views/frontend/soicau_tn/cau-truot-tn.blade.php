...
@section('content')
    ...
    <div class="col-l">
        ...
        <div class="box-content" style="height: auto !important;">
            ...
            <h2 dir="ltr"><strong>Đánh lô trượt được bao nhiêu? tại xosotructiep.online</strong></h2>
            ...
            <h2 dir="ltr"><strong>Kinh nghiệm chơi lô trượt {{$province->name}} với xosotructiep.online :</strong></h2>
