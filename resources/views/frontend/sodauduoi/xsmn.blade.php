...
@section('title','Sớ đầu đuôi MT - Sớ đầu đuôi miền Nam Với xổ sổ trực tiếp')
@section('decription','Sớ đầu đuôi MT Với xổ sổ trực tiếp - Sớ đầu đuôi Miền Nam: Xem đầu đít MT ở giải đặc biệt và giải 8 ở 2 số cuối chính xác và hoàn toàn miễn phí')
@section('keyword','Dự đoán số đầu đuôi miềm nam,số đầu đuôi miền nam, XSĐĐMN')
@section('h1','Sớ đầu đuôi MT - Sớ đầu đuôi miền Nam Với xổ sổ trực tiếp')
@section('breadcrumb')
    <div class="linkway">
        <div class="main">
...
@section('content')
    <div class="col-l">
        ...
        <div class="box-content">
           ...
           <p style="text-align: justify;"><span style="font-weight: 400;"><a title="Sớ Đầu Đu&ocirc;i Miền Nam" href="/so-dau-duoi-xsmn"><strong>Sớ Đầu Đu&ocirc;i Miền Nam</strong></a>. Xem Sớ Đầu Đu&ocirc;i Miền Nam chuẩn nhất tại <a title="xổ sổ trực tiếp" href="/">xosotructiep.online</a></span></p>
            <p style="text-align: justify;"><span style="font-weight: 400;">xosotructiep.online nơi cập nhật Sớ Đầu Đu&ocirc;i Miền Nam ch&iacute;nh x&aacute;c v&agrave; nhanh ch&oacute;ng nhất.</span></p>
            ...
            <p style="text-align: justify;"><span style="font-weight: 400;">Xem Sớ Đầu Đu&ocirc;i, Sớ Đầu Đu&ocirc;i Miền Nam, Sớ Đầu Đu&ocirc;i Miền Trung, Sớ Đầu Đu&ocirc;i Miền Bắc được cập nhật li&ecirc;n tục, ch&iacute;nh x&aacute;c tại <a title="xổ sổ trực tiếp" href="/">xosotructiep.online</a></span></p>
        </div>
